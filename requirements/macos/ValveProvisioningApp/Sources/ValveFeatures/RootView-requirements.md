...
Applies to `macos/ValveProvisioningApp/Sources/ValveFeatures/RootView.swift` and `macos/ValveProvisioningApp/Tests/ValveFeaturesTests/InventoryCopyTests.swift`.
